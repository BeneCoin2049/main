...
const sttaddr = "0x960efbe806358Dc92FCd4831E50728d5499b3a66";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x960efbe806358Dc92FCd4831E50728d5499b3a66";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://benecoin2049.com/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x960efbe806358Dc92FCd4831E50728d5499b3a66',
                    'symbol': 'APPL',
                    'decimals': '18',
                    'image': 'https://benecoin2049.com/images/logo.png',
                },
            },
